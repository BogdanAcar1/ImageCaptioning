...
def create_lstm(vocab_size, max_caption_len):
    input_layer1 = Input(shape = IMG_FEATURES_SHAPE)
    input_layer2 = Input(shape = (max_caption_len, ))
    ...
    sequence_layer1 = Embedding(vocab_size, 256, mask_zero = True)(input_layer2)
    ...
    output_layer = Dense(vocab_size, activation = "softmax")(decoder_layer2)
